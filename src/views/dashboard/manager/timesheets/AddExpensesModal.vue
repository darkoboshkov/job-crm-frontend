<template>
    ...
    >
        ...
        <div class="py-3">
            <div class="row mb-3">
                <div class="col">
                    <span class="color-blue mr-3">Employer:</span>&nbsp;<b-input class="d-inline-block w-50" v-model="company.name" disabled />
                </div>
            </div>

            <div class="row mb-3">
                <div class="col">
                    <span class="color-blue mr-3">Employee:</span>&nbsp;<b-input class="d-inline-block w-50" v-model="worker.name" />
                </div>
            </div>
        </div>
        ...
        <div class="py-3">
            <div class="row mb-3">
                <div class="col">
                    <span class="mr-3">Date:</span>&nbsp;<b-input class="d-inline-block w-50" type="date" />
                </div>
            </div>

            <div class="row mb-3">
                <div class="col">
                    <span class="mr-3">Amount:</span>&nbsp;<b-input class="d-inline-block w-50" placeholder="€0.00" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <b-form-group class="d-inline-block">
                        <b-form-radio v-model="category" name="some-radios" value="travel" class="d-inline-block big-red mr-2">Travel</b-form-radio>
                        <b-form-radio v-model="category" name="some-radios" value="food" class="d-inline-block big-red mr-2">Food</b-form-radio>
                        <b-form-radio v-model="category" name="some-radios" value="other" class="d-inline-block big-red">Other</b-form-radio>
                    </b-form-group>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    <span class="mr-3">Upload receipt:</span>&nbsp;<b-input class="d-inline-block w-50" placeholder="Choose file" />
                </div>
            </div>

            <div class="row mb-3">
                <div class="col">
                    <span class="mr-3">Note:</span>&nbsp;<b-textarea class="d-inline-block w-50" placeholder="Add a note..." />
                </div>
            </div>
        </div>
        ...
        >
            <div class="text-right">
                <button class="btn btn-red">Send Expenses</button>
            </div>
        </b-card>
    </b-modal>
</template>
