<template>
  <div id="page_common_components">
    <div class="container">
      <h1 class="title">Common Components</h1>
      ...
      <section class="common-buttons">
        ...
        >
          ...
          >
            <div class="button-box__label">btn-{{ color }} {{ size }}</div>
            <button :class="'btn btn-' + color + ' ' + size">Button</button>
          </div>
        </div>
        <div
          :key="sizeIndex + '-rec-button'"
          class="items"
          v-for="(size, sizeIndex) in buttonSizes"
        >
          <div
          ...
          >
            ...
            <button :class="'btn btn-' + color + ' ' + size + ' rectangle'">
              Button
            </button>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      buttonColors: ["default", "green", "blue", "red", "black"],
      buttonSizes: ["x-small", "small", "medium", "large"]
    };
  }
};
</script>
